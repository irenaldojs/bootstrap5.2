import { CodePre } from '../customComponents/CodePre';
import { Col, Row, UIHead, UIView, ViewLayout } from '../Objective-UI';
...
export class AccordionView extends UIView {
    ...
    mainTitle = new UIHead({ name: 'mainTitle', headType: 'h1', text: 'Accordion (Acordeão)' })
    mainSubtitle = new UIHead({ name: 'mainSubtitle', headType: 'h2', text: 'Construa acordeões recolhíveis verticalmente' })
    ...
    // #02
    title2 = new UIHead({ name: 'title2', headType: 'h2', text: 'Flush (Sem bordas e fundo)' })
    subtitle2 = new UIHead({
    ...
    // #03
    title3 = new UIHead({ name: 'title3', headType: 'h2', text: 'Always open (Sempre Aberto)' })
    subtitle3 = new UIHead({
